...
import { addPMS } from "../api/pms";

const PerformanceManagementSystemAdd = () => {
  ...
  // const [week, setWeek] = useState(`Week ${weekNumber}`);
...
export default PerformanceManagementSystemAdd;
